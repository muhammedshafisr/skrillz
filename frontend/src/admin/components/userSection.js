                  ...
                  <td className="py-4">
                    ...
                    {x.status === "active" &&
                      <> <span className="pl-4 text-red-600 cursor-pointer" onClick={() => handleBlock(x._id)}>
                        block<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline">
                    ...
                    {x.status === "blocked" &&
                      <> <span className="pl-4 text-green-600 cursor-pointer" onClick={() => handleUnBlock(x._id)}>
                        active<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline">
