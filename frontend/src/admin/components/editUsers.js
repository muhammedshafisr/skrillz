            ...
            <div className="section_padder mr-3 my-16 ml-2 md:my-24 md:ml-40 md:mr-4 bg-slate-900">
                <div className="flex flex-col items-center pt-5">
                    <form className="flex flex-col justify-center items-center" onSubmit={handleSubmit}>
                        <h1 className="font-normal text-xl subpixel-antialiased text-slate-50 select-none mb-2">Edit user</h1>
                        <h2 id="success_log" className="text-green-600 hidden">Successfully updated</h2>
