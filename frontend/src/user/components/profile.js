...
import { addCover, removeCover, updateCover } from "../../redux/ducks/profile";
    ...
    <>
      ...
      <div className="img_container">
            ...
            <div className="flex justify-end">
              <div className="flex text-sm text-gray-600">
                <label
                  onClick={showSaveButton}
                  htmlFor="file-upload"
                  className="relative cursor-pointer rounded-md bg-slate-900 font-medium text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-sky-500 focus-within:ring-offset-2 hover:text-indigo-500"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
        ...
        <div className="flex justify-between mt-5">
          ...
          <button className="select-none text-neutral-50 shadow-cyan-800 bg-sky-500 w-32 h-8  hover:bg-sky-600 active:bg-sky-300 focus:outline-none focus:ring focus:ring-green-400 transition ease-in-out duration-1000">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
        ...
        <div className="flex p-9 border-b border-slate-800">
          <div className="border-l-2 border-l-cyan-600 flex justify-center px-7">
            <button className="md:px-2 cursor-pointer text-slate-400 hover:bg-sky-600 active:bg-sky-300 focus:outline-none focus:ring focus:ring-green-400 transition ease-in-out duration-1000">
              Videos
            </button>
          </div>
          <div className="border-l-2 border-l-cyan-600 flex justify-center px-7">
            <button className="md:px-2 cursor-pointer text-slate-50 hover:bg-sky-600 active:bg-sky-300 focus:outline-none focus:ring focus:ring-green-400 transition ease-in-out duration-1000">
              Live
            </button>
          </div>
          <div className="border-l-2 border-l-cyan-600 flex justify-center px-7">
          ...
          <div className="border-x-2 border-x-cyan-600 flex justify-center px-7">
            <button className="md:px-2 cursor-pointer text-slate-50 hover:bg-sky-600 active:bg-sky-300 focus:outline-none focus:ring focus:ring-green-400 transition ease-in-out duration-1000">
              About
            </button>
          </div>
